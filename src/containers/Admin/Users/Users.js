...
class adminUsers extends Component {
  ...
  componentDidMount() {
    this.props.onGetData("users",thisServiceName);
...
const mapDispatchToProps = dispatch => {
  return {
    onGetData: (nameSpace, serviceName) => dispatch(adminActions.getData(nameSpace, serviceName)),
    onDeleteItem: (nameSpace, serviceName, item) => dispatch(adminActions.deleteItem(nameSpace, serviceName, item)),
    onDeleteItemSuccess: (nameSpace, serviceName, item) => dispatch(adminActions.deleteItemSuccess(nameSpace, serviceName, item)),
    onSetPagination: (nameSpace, serviceName, pagination) => dispatch(adminActions.setPagination(nameSpace, serviceName, pagination)),
    onSetQuery: (nameSpace, serviceName, query) => dispatch(adminActions.setQuery(nameSpace, serviceName, query)),
    onSetNewItem: (nameSpace, serviceName, post) => dispatch(adminActions.setNewItem(nameSpace, serviceName, post))
  };
};


export default connect(mapStateToProps, mapDispatchToProps)(notificationHandler(adminUsers));
